...
class Review {
    ...
    static getProfile(id) {
        let sql = `SELECT registeredUser.firstName, registeredUser.lastName, registeredUser.email, registeredUser.bio, registeredUser.picture, registeredUser.user_rating, registeredUser.role, review.rating, review.description, review.referLandlordId FROM registeredUser LEFT OUTER JOIN review ON registeredUser.reg_user_id = review.reg_user_id
            WHERE registeredUser.reg_user_id = ${id};`;
        return db.execute(sql);
    }
